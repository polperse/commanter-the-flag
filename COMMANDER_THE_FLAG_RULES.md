...
1. That team has its own Flag and the enemy Flag secured in its Tower Zone.
2. That team keeps both Flags secured in its Tower Zone for **3 consecutive team upkeeps**.

A team cannot win if it does not control its own Flag, even if it controls the enemy Flag.

### 2.1 Tracking The Win Condition

At the beginning of a team's upkeep, after all Flag securing and Flag returning checks for that upkeep have been resolved, check whether that team has both Flags secured in its Tower Zone.

- If it does, that team gains 1 victory count.
- If it does not, that team's victory count resets to 0.
- If a team's victory count reaches 3, that team wins the game.

---

## 3. Teams, Shared Turns, And Player Resources
...
### 3.1 No Normal Player Life Totals
...
### 3.2 Individual Players Still Exist
...
Each team's Tower Zone contains:

- that team's Flag, if secured
...
- the enemy team cannot capture that team's Flag
- that team does not have Morale

### 5.1 Damaging The Wall
...
### 5.2 Life Loss And Noncombat Damage While The Wall Is Up
...
### 5.3 Poison, Infect, And Wither While The Wall Is Up
...
### 6.3 Noncombat Damage To Players
...
### 6.5 Checking Or Setting Life Totals
...
### 6.6 Morale And The Flag Keeper

Morale modifies your Flag Keeper during assaults.
...
These modifiers only matter during an assault against your Flag Keeper.

### 6.7 Poison After The Wall Is Broken
...
### 6.8 Wither And Infect After The Wall Is Broken

If a source with wither or infect would deal damage to a Flag Keeper, that damage does not place -1/-1 counters on the Flag Keeper.

Instead, the defending team loses that much Morale.

That source is treated as having dealt damage for trigger purposes, but no damage is marked on the Flag Keeper from wither or infect damage.
...
- can only be damaged or destroyed through combat during an assault against the Tower
...
## 9. Tower Combat And Assaults

During combat, an attacking team may declare attacks against:

- an enemy Tower
- an enemy Flag Keeper, if that Tower's Wall HP is 0
- an enemy creature carrying your team's Flag
- a dropped Flag, if attempting to recover or contest it
...
### 9.2 Assaulting The Flag Keeper

When a Tower's Wall HP is 0, attackers may declare an assault against that Tower's Flag Keeper during combat.

Assault process:

1. The attacking team declares which attacking creatures are participating in the assault.
2. The defending team declares blockers from the battlefield.
3. Blocked creatures fight their blockers on the battlefield.
4. Unblocked creatures reach the Flag Keeper.
5. Relevant Flag Keeper abilities trigger or apply.
6. Combat damage involving the Flag Keeper is resolved using the special Flag Keeper combat rules.
7. If the Flag Keeper receives lethal damage, it is destroyed.

### 9.3 Evasion During Assaults

During an assault against a Flag Keeper, evasion abilities such as flying, reach, landwalk, menace, fear, intimidate, shadow, or similar abilities apply normally when determining whether defending creatures can block attacking creatures.

For example, if a flying creature assaults the Tower and the defending team has no creatures with flying or reach, that flying creature cannot be blocked by the defending team's ground creatures and reaches the Flag Keeper.

However, no evasion ability allows an attacking creature to bypass the Flag Keeper or capture the Flag directly.

If an attacking creature is not blocked during an assault, it reaches the Flag Keeper and must fight the Flag Keeper before any Flag can be captured.

The Flag Keeper itself cannot be bypassed by flying, landwalk, unblockable effects, or similar evasion abilities.

### 9.4 Flag Keeper Combat Damage

During an assault, each unblocked attacking creature that reaches the Flag Keeper may deal combat damage to the Flag Keeper according to normal combat damage timing.
...
### 9.5 Flag Keeper Abilities

Flag Keeper abilities function only during an assault against the Flag Keeper.

They do not affect attacks against the Wall.

They do not affect creatures outside the assault.
...
- happens before normal combat damage during an assault
...
## 10. Capturing The Enemy Flag

To capture the enemy Flag, all of the following must be true:

1. The enemy Wall must have 0 Wall HP.
2. The enemy Flag Keeper must have been defeated in combat.
3. The capturing creature must have base power 2 or greater.

Any creature with base power 2 or greater can capture the enemy Flag. It does not have to be a commander.

Temporary power boosts, +1/+1 counters, Equipment, Auras, anthem effects, and similar modifiers do not allow a creature with base power 1 or less to capture or pick up a Flag.

### 10.1 Carried Flag

Once captured, the Flag becomes carried.
...
- it cannot be cloned as a way to duplicate the Flag

### 10.2 Ward From The Flag
...
### 10.3 Retreat And Securing The Flag

The creature that captured the Flag does not secure it immediately.

The Flag remains carried for at least one full opposing team turn.

At the beginning of the carrier team's next upkeep, if the Flag Carrier is still on the battlefield, the Flag becomes secured and enters that team's Tower Zone.
...
- creatures from the opposing team may attack the dropped Flag to recapture or secure it again
- enemy creatures may block those attacks to protect or contest the Flag

---

## 12. Recovering Your Own Flag
...
The final damage that defeats the carrier must be:

- combat damage
- dealt by a creature with base power 2 or greater
...
### 12.1 Picking Up A Dropped Flag

A creature can pick up a dropped Flag if:

- it has base power 2 or greater
- it attacked the dropped Flag with the intent to recover, recapture, or secure it
- it was not stopped by blockers

That creature becomes the new Flag Carrier and gains Ward {2} from the Flag.

If a team picks up its own Flag, that Flag is considered recovered.

If a team picks up the enemy Flag, that Flag is considered captured again.

### 12.2 Returning A Recovered Flag

A recovered Flag does not immediately return to the Tower.

At the beginning of the carrier team's next upkeep, if the Flag Carrier is still on the battlefield, the Flag returns to its team's Tower Zone.

This creates symmetry between capturing an enemy Flag and recovering your own Flag.

---

## 13. Evasion Against The Wall

Landwalk abilities such as islandwalk, swampwalk, forestwalk, and similar abilities function against the Wall.

When a creature with landwalk attacks a Tower, if the defending team controls a land of the relevant type, that creature cannot be blocked and its combat damage is dealt directly to the Wall.

Landwalk does not affect the Flag Keeper directly during an assault and does not allow a creature to bypass the Flag Keeper.

---

## 14. Control, Auras, And Flag Carriers
...
## 15. Alternative Win And Loss Effects
...
- Creatures carrying Flags cannot be stolen, cloned, copied, or have their control changed.
...
### 18.2 Intermediate Flag Keepers
...
**Gameplay:** Forces attackers to assault through another color.
...
**Gym:** This Flag Keeper gains a training counter after each combat it survives. Remove 2 training counters from it: put a +1/+1 counter on it.
...
**Yummy:** For every 3 creatures this Flag Keeper kills, put a +1/+1 counter on it.
...
Community submissions should support the core siege-and-capture structure of the format and avoid hard locks, non-combat wins, or designs that make the Flag Keeper impossible to meaningfully assault.

---

**End of Rules**  
**Commander the Flag — v1.0 Playtest Updated Draft**
